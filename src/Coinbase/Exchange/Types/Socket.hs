...
instance FromJSON ExchangeMessage where
    parseJSON (Object m) = do
        ...
        case (msgtype :: String) of
            "hearbeat" -> Heartbeat <$> m .: "time" <*> m .: "product_id" <*> m .: "sequence" <*> m .: "last_trade_id"
            "open" ->
                Open <$> m .: "time" <*> m .: "product_id" <*> m .: "sequence" <*> m .: "order_id" <*> m .: "side" <*>
                m .: "remaining_size" <*>
                m .: "price" <*>
                m .:? "user_id" <*>
                m .:? "profile_id"
            "done" ->
                Done <$> m .: "time" <*> m .: "product_id" <*> m .: "sequence" <*> m .: "order_id" <*> m .: "side" <*>
                m .: "reason" <*>
                m .:? "price" <*>
                m .:? "remaining_size" <*>
                m .:? "user_id" <*>
                m .:? "profile_id"
            "match" ->
                Match <$> m .: "time" <*> m .: "product_id" <*> m .: "sequence" <*> m .: "side" <*> m .: "trade_id" <*>
                m .: "maker_order_id" <*>
                m .: "taker_order_id" <*>
                m .: "size" <*>
                m .: "price" <*>
            ...
            "change" -> do
                ms <- m .:? "price"
                let market =
                        ChangeMarket <$> m .: "time" <*> m .: "product_id" <*> m .: "sequence" <*> m .: "order_id" <*>
                        m .: "side" <*>
                        m .: "new_funds" <*>
                        m .: "old_funds" <*>
                        m .:? "user_id" <*>
                        m .:? "profile_id"
                    limit =
                        ChangeLimit <$> m .: "time" <*> m .: "product_id" <*> m .: "sequence" <*> m .: "order_id" <*>
                        m .: "side" <*>
                        m .: "price" <*>
                        m .: "new_size" <*>
                        m .: "old_size" <*>
            ...
            "received" -> do
                ...
                case typ of
                    Limit ->
                        ReceivedLimit <$> m .: "time" <*> m .: "product_id" <*> m .: "sequence" <*> m .: "order_id" <*>
                        m .: "side" <*>
                        ...
                        m .:? "profile_id"
                    Market ->
                        ReceivedMarket <$> m .: "time" <*> m .: "product_id" <*> m .: "sequence" <*> m .: "order_id" <*>
                        m .: "side" <*>
                        pure mcid <*>
                        ...
                        m .:? "profile_id"
            "activate" ->
                Activate <$> m .: "time" <*> m .: "product_id" <*> m .: "order_id" <*> m .: "side" <*> m .: "stop_type" <*>
                m .: "stop_price" <*>
                m .:? "limit_price" <*>
                m .: "funds" <*>
                m .: "taker_fee_rate" <*>
...
instance ToJSON ExchangeMessage where
    ...
    toJSON Match {..} =
        ...
        optionalField "taker_user_id" msgTakerUserId ++ optionalField "taker_profile_id" msgTakerProfileId
    toJSON Error {..} = object ["type" .= ("error" :: Text), "message" .= msgMessage]
    toJSON ChangeLimit {..} =
        object $
        [ "type" .= ("change" :: Text)
        , "time" .= msgTime
