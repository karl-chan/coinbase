...
start =
  Just $
  parseTimeOrError True defaultTimeLocale "%FT%X%z" "2015-04-12T20:22:37+0000"

end :: Maybe UTCTime
end =
  Just $
  parseTimeOrError True defaultTimeLocale "%FT%X%z" "2015-04-23T20:22:37+0000"
...
mkConf = do
  ...
  let apiType =
        case sbox of
          ...
          _ ->
            error
              "Coinbase sandbox option must be either: TRUE or FALSE (all caps)"
